...
void QSharer::setupUi(QMainWindow *QSharerClass)
{
	...
	listView->setGeometry(QRect(20, 20, 441, 271));
...
{ 
	...
	QString pass = PassEdit->text();  
	QThread *createWifi = new Thread_Create(wifiname, pass);
...
void QSharer::createFailed(int e)
{
	...
	switch (e)
	{
	case 0:  QMessageBox::about(this, "Failed", "Failed to initiate hosted network!");      break;
	case 1:  QMessageBox::about(this, "Failed", "Wlan hosted network unavailable!");        break;
	case 2:  QMessageBox::about(this, "Failed", "Failed to stop previous hosted network!"); break;
	case 3:  QMessageBox::about(this, "Failed", "Failed to allow hosted network!");         break;
	case 4:  QMessageBox::about(this, "Failed", "Failed to set ssid!");                     break;
	case 5:  QMessageBox::about(this, "Failed", "Failed to set key!");                      break;
	case 6:  QMessageBox::about(this, "Failed", "Failed to start hosted network!");         break;
	//case 7:  QMessageBox::about(this, "Failed", "Failed to unshare prev hosted network!");  break;
	case 7:  QMessageBox::about(this, "Failed", "Failed to share hosted network!");         break;
	default: QMessageBox::about(this, "Failed", "Unknown error!");                          break;
	}
...
void QSharer::discFailed(int e)
{
	...
	switch (e)
	{
	case 0:  QMessageBox::about(this, "Failed", "Failed to stop hosted network!");    break;
	case 1:  QMessageBox::about(this, "Failed", "Failed to reset key!");              break;
	case 2:  QMessageBox::about(this, "Failed", "Failed to unshare hosted network!"); break;
	default: QMessageBox::about(this, "Failed", "Unknown error!");                    break;
	}
